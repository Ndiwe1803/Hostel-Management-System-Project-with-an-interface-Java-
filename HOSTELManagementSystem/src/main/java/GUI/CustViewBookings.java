 ...
 * @author G5
 */
public class CustViewBookings extends javax.swing.JFrame {

    /** Creates new form CustViewBookings */
    public CustViewBookings() {
        initComponents();
        loadHostelsData();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CustViewBookings.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CustViewBookings().setVisible(true);
            }
        });
    }
    ...
    private void loadHostelsData() {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(filePath))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (data.length >= 4 && data[0].equals(CustomerViewHostels.roomSelectedID)) {
                    model.addRow(data);
                }
            }
        } catch (IOException e) {
